...
export default function Home() {
  ...
  return (
    <main>
      ...
      {/* Zo werkt het */}
      <section style={{ background: "#C0B7EA", padding: "100px 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "24px" }}>
            {[
              ...
              <div key={item.step} style={{
                ...
                border: "1px solid rgba(42,23,88,0.1)",
                borderRadius: "24px",
                padding: "40px 32px",
                textAlign: "left",
                position: "relative",
              }}>
                <span style={{ position: "absolute", top: "24px", right: "24px", fontSize: "12px", opacity: 0.2, fontWeight: 700, color: "#2A1758" }}>
                  {item.step}
                </span>
                <div style={{ width: "40px", height: "3px", background: "#2A1758", borderRadius: "2px", marginBottom: "24px" }} />
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", fontWeight: 700, marginBottom: "12px", color: "#2A1758" }}>
                  {item.title}
                </h3>
                <p style={{ color: "rgba(42,23,88,0.6)", lineHeight: 1.65, fontSize: "15px", fontWeight: 400 }}>
                  {item.desc}
                </p>
              </div>
            ))}
