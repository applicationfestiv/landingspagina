  ...
  return (
    <main>
      ...
      <nav style={{
        ...
        background: "rgba(192,183,234,0.92)",
      ...
      <section style={{
        ...
        <div style={{ position: "relative", maxWidth: "780px" }}>
          ...
          <p style={{
            ...
            Je gaat al naar een geweldig festival met je vrienden. Match van te voren of tijdens met mensen die daar ook zijn en spreek spontaan af bij een stage of andere meet up.
          </p>
          ...
          <a
            ...
            style={{
              ...
              fontWeight: 700,
              textDecoration: "none",
              boxShadow: "0 8px 40px rgba(42,23,88,0.2)",
              transition: "all 0.2s",
            }}
            onMouseEnter={e => {
              e.currentTarget.style.transform = "translateY(-2px)";
              e.currentTarget.style.boxShadow = "0 14px 48px rgba(42,23,88,0.3)";
            }}
            onMouseLeave={e => {
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.boxShadow = "0 8px 40px rgba(42,23,88,0.2)";
            }}
          >
      ...
      {/* Hoe het werkt — donkere achtergrond */}
      <section style={{
        background: "#2A1758",
        padding: "100px 24px",
      }}>
        ...
        <div style={{ maxWidth: "520px", margin: "0 auto" }}>
          ...
          {!submitted ? (
            ...
            >
              ...
              {error && (
                <p style={{ color: "#FFD166", fontSize: "14px" }}>{error}</p>
              )}
