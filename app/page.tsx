          ...
          >
            ...
            {overOnsOpen && (
              <div style={{
                ...
                {["Ons team", "Werken bij"].map((sub) => (
                  <a
                    key={sub}
                    href={`/over-ons/${sub.toLowerCase().replace(/ /g, "-")}`}
                    style={{
                      display: "block",
                      padding: "9px 14px",
                      fontSize: "14px",
      ...
      <section style={{
        ...
        <div style={{ position: "relative", maxWidth: "780px" }}>
          ...
          <p style={{
            ...
            Je gaat naar een geweldig festival of evenement met je favoriete mensen. Match van te voren met mensen die ook gaan. Of tijdens. Spreek spontaan linksvoor af bij een stage, of bij dat ene stukje waar je lekker kunt zitten. En wie weet wordt een mooie dag nóg mooier.
          </p>
